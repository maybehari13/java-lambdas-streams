...
//    Function<x, y> = Accepts an arg and returns a result
//    x = Type of input arg
//    y = Type of return result
...
//    Predicate<x, y> = Accepts an arg and returns a boolean
//    x = Type of input arg
//    No need to specify type in the lambda Args - boolean checks do not need ternary operator statements
